  ...
  return (
    <main className="h-full">
      ...
      <section className="mt-4 h-96">
        <Textarea
          className="w-full h-full overflow-y-auto bg-background/40 border-border resize-none select-none cursor-default ring-0 focus:ring-0 focus:ring-offset-0 focus-visible:ring-0 focus-visible:ring-offset-0"
          readOnly
          value={analysisData}
        />
