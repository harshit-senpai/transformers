    ...
    (acceptedFiles: File[], rejectedFiles: FileRejection[]) => {
      ...
      const newFiles = acceptedFiles.map((file) =>
        Object.assign(file, {
          ...
          isMachineReadable: checkMachineReadability(file),
        })
      )
...
interface FileCardProps {
  file: File & { isMachineReadable: boolean }
  onRemove: () => void
  progress?: number
}
...
function checkMachineReadability(file: File): boolean {
  const machineReadableTypes = ["application/pdf", "text/plain"]
  return machineReadableTypes.includes(file.type)
}